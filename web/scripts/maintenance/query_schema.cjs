...
async function querySchema() {
    try {
        ...
        const res = await client.query("SELECT table_name, column_name, data_type FROM information_schema.columns WHERE table_name IN ('contracts', 'invoices', 'quotations') ORDER BY table_name;");
