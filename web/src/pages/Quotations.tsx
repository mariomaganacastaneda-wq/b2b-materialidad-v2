...
const getStatusColor = (status: string | null | undefined, isProforma: boolean = false) => {
    ...
    if (['emitida', 'timbrada'].includes(lower)) {
        return "text-cyan-400 border-cyan-500/40 bg-cyan-500/20";
    }

    // Teal para Prefacturas
    if (lower.includes('prefactura')) {
        return "text-teal-400 border-teal-500/40 bg-teal-500/20";
    }
            ...
            <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1 group">
                    ...
                    <input
                        ...
                        aria-label="Buscar por cliente, descripción o folio"
                                        ...
                                        <tr key={q.id} className="hover:bg-white/5 transition-colors group">
                                            ...
                                            <td className="p-5">
                                                <div className="flex flex-col">
                                                    <span className="text-white font-bold text-[13px] group-hover:text-cyan-300 transition-colors uppercase truncate max-w-md">
